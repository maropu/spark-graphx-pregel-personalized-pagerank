...
import org.apache.spark.util.PeriodicCheckpointerEx
 ...
 *
 */
private[spark] class PeriodicGraphCheckpointerEx[VD, ED](
    checkpointInterval: Int,
    sc: SparkContext)
  extends PeriodicCheckpointerEx[Graph[VD, ED]](checkpointInterval, sc) {
  ...
  override protected def unpersist(data: Graph[VD, ED]): Unit = data.unpersist(blocking = true)
