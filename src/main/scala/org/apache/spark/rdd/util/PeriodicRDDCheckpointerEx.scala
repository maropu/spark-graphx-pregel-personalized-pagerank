 ...
 */
private[spark] class PeriodicRDDCheckpointerEx[T](
    checkpointInterval: Int,
    sc: SparkContext)
  extends PeriodicCheckpointerEx[RDD[T]](checkpointInterval, sc) {
  ...
  override protected def unpersist(data: RDD[T]): Unit = data.unpersist(blocking = true)
